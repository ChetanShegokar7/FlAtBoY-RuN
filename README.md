...
2.After downloading unzip the FlAtBoY RuN.rar file using winrar or any other software.
3.Now run the FlAtBoY RuN installer and tick on create desktop icon.
4.Now run FlAtBoY RuN from desktop. 
